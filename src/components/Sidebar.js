...
import { faBook, faBoxOpen, faChartPie, faCog, faFileAlt, faHandHoldingUsd, faHouseUser, faPuzzlePiece, faQuestionCircle, faSearch, faSignOutAlt, faTable, faTimes } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title={`Bonjour ${UserName}`}   />

              <NavItem title="Dashboard" link={Routes.DashboardOverview.path} icon={faHouseUser} />
              <NavItem title="Bibilothèque questions" icon={faPuzzlePiece} link={Routes.Transactions.path} />
              <NavItem title="Enquête" icon={faFileAlt} link={Routes.Settings.path} />
              <NavItem title="Statistique"  icon={faChartPie} link={Routes.Stat.path} />
